...
export class ApiInterceptor implements HttpInterceptor {
  ...
  intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    const token = this.authService.getToken();
      // || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2ZWQ3MzRjNmJlZjJmMmJmZjBmZDIwYyIsImlhdCI6MTcyNjgzNzU4MCwiZXhwIjoxNzI2ODQxMTgwfQ.oya9fWXx1-zXgGGSrTOU_LO3c0kHi48jQe8vS6hgNB0';
